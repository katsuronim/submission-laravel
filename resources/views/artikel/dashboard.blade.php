...
<table class="table table-bordered table-dark col-11" style="margin:40px">
    <tbody>
        ...
        <tr>
            <td><img src="/gambar_artikel/{{ $item->gambar_artikel }}" width="300px" style="margin-left:auto;margin-right:auto"></td>
            <td class="text-center">{{ $item->judul_artikel }}</td>
            <td class="text-center">{{ $item->kategori->nama_kategori }}</td>
            <td class="text-center">
                <a class="btn btn-outline-info" href="{{ route('artikel.showGuest',$item->id) }}">Show</a>
            </td>
        </tr>
        @empty
        <tr>
